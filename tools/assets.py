...
draw.text((84, 576), "mkdigital.site", font=small, fill=(120, 120, 120))
...
PAGES = [("", "1.0"), ("work.html", "0.9"), ("offer.html", "0.8"), ("process.html", "0.7"),
         ("included.html", "0.7"), ("pricing.html", "0.9"), ("contact.html", "0.9")]
urls = "\n".join(
...
print("  site.webmanifest, robots.txt, sitemap.xml, favicon.svg written")
