...
Upload the **contents of `site/`** to the publishing source for your GitHub Pages
repository, with `index.html` at the top level. GitHub Pages supplies the public
`github.io` address automatically. The website itself contains no fixed website URL.

The pages use relative paths, so they work as a GitHub Pages user site or project site.

If you edit the source files and want to rebuild the pages, run:
